...
public class CameraFade : MonoBehaviour
{
    ...
    private static bool killOnFinish;
    ...
    /// Fade duration.
    /// </param>
    public static void StartAlphaFade(Color newScreenOverlayColor, bool isFadeIn, float fadeDuration, bool killOnFinish = true)
    {
        CameraFade.killOnFinish = killOnFinish;
    ...
    /// </param>
    public static void StartAlphaFade(Color newScreenOverlayColor, bool isFadeIn, float fadeDuration, float fadeDelay, Action OnFadeFinish, bool killOnFinish = true)
    {
        CameraFade.killOnFinish = killOnFinish;
