...
public class NPCBehavior : MonoBehaviour, INPCBehavior
{
    ...
    private Looking currentWalkingDirection = Looking.Right;
    private bool hasGoneToPrevPos = false;
    ...
    private Looking GetDirectionFromTwoPositions(Vector3 p1, Vector3 p2)
    {
        ...
        norm = new Vector3(Mathf.RoundToInt(norm.x), Mathf.RoundToInt(norm.y));
    ...
    //Check if player is front of me
    ...
    //If the player comes in this trigger, I will check it th player is coming in front of me
    //by raycasting
